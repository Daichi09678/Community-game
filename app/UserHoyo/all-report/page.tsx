  ...
  return (
    <div>
      <div className="section-header">
        <div className="section-heading">Reports Library</div>
        <div className="report-count">{filteredReports.length} reports found</div>
      </div>
      ...
      <table className="reports-table">
        ...
        <tbody>
          {filteredReports.length === 0 ? (
            <tr>
              <td colSpan={7} style={{ textAlign: 'center', padding: '2rem', color: 'var(--text-muted)', fontFamily: "'Space Mono', monospace", fontSize: '0.8rem' }}>
        ...
        {[
          ...
          <div key={i} style={{ marginBottom: '10px' }}>
            ...
            <div className="bar-track">
              <div className={`bar-fill ${g.cls}`} style={{ width: `${g.pct}%` }} />
            </div>
          </div>
        ))}
      </div>
    ...
    <>
      ...
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          <a className="nav-item" href="/UserHoyo/homepage">
          ...
          <a className="nav-item active" href="/all-report">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
          ...
          <a className={`nav-item ${filterType === 'mission' ? 'active' : ''}`} onClick={() => handleCategoryFilter('mission')}>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
          ...
          <a className={`nav-item ${filterType === 'event' ? 'active' : ''}`} onClick={() => handleCategoryFilter('event')}>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
          ...
          <a className={`nav-item ${filterType === 'puzzle' ? 'active' : ''}`} onClick={() => handleCategoryFilter('puzzle')}>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
        ...
        <div className="topbar">
          <div>
            <div className="topbar-title">
              Reports — {gameFilter === 'all' ? 'All Games' : gameBadgeMap[gameFilter]?.label}
              {filterType !== 'all' && ` / ${filterType.charAt(0).toUpperCase() + filterType.slice(1)}`}
            </div>
            <div className="topbar-subtitle">Browse community guides, analysis, and walkthroughs</div>
          </div>
          ...
          <div className="game-pills">
            {(['all', 'hsr', 'gi', 'zzz', 'hi3'] as const).map(g => {
              ...
              return (
                <span
                  key={g}
                  className={`game-pill pill-${g} ${gameFilter === g ? 'active' : ''}`}
      ...
      <style jsx global>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .sidebar-header { padding: 1.75rem 1.5rem; border-bottom: 0.5px solid var(--dark-border); }
        .sidebar-logo {
        ...
        .nav-group-label {
          ...
          padding: 0 0.75rem; margin-bottom: 0.5rem; margin-top: 1.5rem;
        }
        ...
        .user-avatar {
          ...
          border: 1.5px solid var(--gold-dim); background: rgba(200,169,110,0.1);
        ...
        .topbar {
          ...
          padding: 1rem 2rem; border-bottom: 0.5px solid var(--dark-border);
        ...
        .game-pill {
          ...
          clip-path: polygon(6px 0, 100% 0, calc(100% - 6px) 100%, 0 100%);
          border: 0.5px solid transparent; color: var(--text-muted);
        ...
        .report-count    { color: var(--text-muted); font-size: 0.75rem; font-family: 'Space Mono', monospace; }
        ...
        .reports-table td { padding: 14px 16px; font-size: 0.88rem; border-bottom: 0.5px solid rgba(200,169,110,0.07); vertical-align: middle; }
        ...
        .trending-tag.gold   { background: rgba(200,169,110,0.12); border-color: rgba(200,169,110,0.3); color: var(--gold-bright); }

        .bar-track { height: 4px; background: rgba(255,255,255,0.05); overflow: hidden; }
