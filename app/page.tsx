...
export default function Landing() {
  const [bgScene, setBgScene] = useState<number>(0);
  ...
  const statsData: [string, string][] = [
    ['12,480', 'Total Reports'],
    ['31.6K', 'Active Trailblazers'],
    ['4,230', 'Puzzles Solved'],
    ['3', 'Events Active']
  ];
  ...
  const stepsData: [string, string, string][] = [
    ['01', 'Explore Reports', 'Browse thousands of guides filtered by type, version, and community rating.'],
    ['02', 'Rate & Discuss', 'Vote, leave feedback, and engage in discussions to help the community thrive.'],
    ['03', 'Contribute', 'Write reports, earn XP, and rise through the Trailblazer leaderboard ranks.']
  ];
  ...
  return (
    <>
      ...
      <div suppressHydrationWarning>
        ...
        <motion.svg 
          className={`bg-scene${bgScene === 0 ? ' active' : ''}`} 
          viewBox="0 0 1440 900" 
          preserveAspectRatio="xMidYMid slice" 
          xmlns="http://www.w3.org/2000/svg"
          initial={{ opacity: 0 }}
          animate={{ opacity: bgScene === 0 ? 1 : 0 }}
        ...
        <motion.svg 
          className={`bg-scene${bgScene === 1 ? ' active' : ''}`} 
          viewBox="0 0 1440 900" 
          preserveAspectRatio="xMidYMid slice" 
          xmlns="http://www.w3.org/2000/svg"
          initial={{ opacity: 0 }}
          animate={{ opacity: bgScene === 1 ? 1 : 0 }}
          transition={{ duration: 1.4 }}
        >
        ...
        <motion.svg 
          className={`bg-scene${bgScene === 2 ? ' active' : ''}`} 
          viewBox="0 0 1440 900" 
          preserveAspectRatio="xMidYMid slice" 
          xmlns="http://www.w3.org/2000/svg"
          initial={{ opacity: 0 }}
          animate={{ opacity: bgScene === 2 ? 1 : 0 }}
          transition={{ duration: 1.4 }}
        >
        ...
        <motion.svg 
          className={`bg-scene${bgScene === 3 ? ' active' : ''}`} 
          viewBox="0 0 1440 900" 
          preserveAspectRatio="xMidYMid slice" 
          xmlns="http://www.w3.org/2000/svg"
          initial={{ opacity: 0 }}
          animate={{ opacity: bgScene === 3 ? 1 : 0 }}
          transition={{ duration: 1.4 }}
        >
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <motion.nav 
          ...
          style={{ position: 'sticky', top: 0, zIndex: 100, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '.9rem 2.5rem', background: 'rgba(5,8,16,.92)', backdropFilter: 'blur(20px)', borderBottom: '.5px solid rgba(200,169,110,.13)' }}
        >
          ...
          <div style={{ display: 'flex', gap: '.6rem' }}>
            <Link href="/Sign-in">
              <motion.button 
                className="fr nav-btn-signin" 
                style={{ clipPath: CLIP.navpill, padding: '.45rem 1.1rem', background: 'rgba(200,169,110,.08)', border: '.5px solid rgba(200,169,110,.13)', color: '#C8A96E', fontSize: '.75rem', fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase' }}
                whileHover={{ scale: 1.05, backgroundColor: 'rgba(200,169,110,.16)' }}
                whileTap={{ scale: 0.96 }}
              >
                Sign In
              </motion.button>
            ...
            <Link href="/Sign-up">
              <motion.button 
                className="fr nav-btn-signup" 
                style={{ clipPath: CLIP.navpill, padding: '.45rem 1.3rem', background: 'linear-gradient(135deg,#7A5A24,#C8A96E)', border: 'none', color: '#060911', fontSize: '.75rem', fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase' }}
        ...
        <motion.section 
          ...
          animate="visible"
          variants={fadeIn}
          style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '7rem 2rem 5rem', position: 'relative' }}
        >
          ...
          <motion.h1 
            ...
            style={{ fontSize: 'clamp(2.6rem,5.5vw,4.8rem)', fontWeight: 900, lineHeight: 1.04, letterSpacing: '.03em', marginBottom: '1.5rem' }}
          >
          ...
          <motion.p 
            ...
            style={{ maxWidth: 520, fontSize: '1rem', lineHeight: 1.75, color: '#8A8070', marginBottom: '2.5rem' }}
          >
          ...
          <motion.div 
            ...
            style={{ display: 'flex', gap: '.85rem', justifyContent: 'center', flexWrap: 'wrap', marginBottom: '4.5rem' }}
          >
            <motion.button
              ...
              whileHover={{ scale: 1.05, opacity: 0.88 }}
              whileTap={{ scale: 0.97 }}
          ...
          <motion.div 
            ...
            style={{ clipPath: CLIP.lg, border: '.5px solid rgba(200,169,110,.13)', background: 'rgba(11,17,33,.85)', backdropFilter: 'blur(12px)', overflow: 'hidden' }}
          >
            {statsData.map(([v, l], i, arr) => (
              <motion.div 
                key={l} 
                className="stat-line stat-cell" 
                style={{ position: 'relative', flex: 1, padding: '1.5rem 1.75rem', borderRight: i < arr.length - 1 ? '.5px solid rgba(200,169,110,.13)' : 'none', cursor: 'default' }}
                whileHover={{ backgroundColor: '#0e1825' }}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
        ...
        <motion.section 
          ...
          variants={fadeInUp}
          style={{ position: 'relative', zIndex: 1, padding: '4rem 2.5rem' }}
        >
          ...
          <motion.div 
            ...
            style={{ maxWidth: 1060, margin: '0 auto', border: '.5px solid rgba(200,169,110,.13)', overflow: 'hidden', clipPath: CLIP.lg }}
          >
            {featuresData.map((f, i) => (
              <motion.div 
                ...
                variants={fadeInUp}
                style={{ position: 'relative', background: 'rgba(11,17,33,.9)', padding: '2.25rem 2rem', overflow: 'hidden', cursor: 'default', borderRight: [0, 1, 3, 4].includes(i) ? '.5px solid rgba(200,169,110,.13)' : 'none', borderBottom: i < 3 ? '.5px solid rgba(200,169,110,.13)' : 'none' }}
                whileHover={{ backgroundColor: '#0d1628' }}
              >
            ...
            <div className="split-layout">
              ...
              >
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '.85rem' }}>
                  {stepsData.map(([n, t, d], idx) => (
                    <motion.div 
                      key={n} 
                      className="step-card" 
                      style={{ clipPath: CLIP.step, display: 'flex', alignItems: 'flex-start', gap: '1rem', padding: '1.1rem 1.25rem', background: 'rgba(11,17,33,.85)', border: '.5px solid rgba(200,169,110,.13)', cursor: 'default' }}
                      initial={{ opacity: 0, x: -20 }}
                      whileInView={{ opacity: 1, x: 0 }}
                      viewport={{ once: true }}
                      transition={{ delay: idx * 0.1, duration: 0.4 }}
                      whileHover={{ backgroundColor: '#101928', borderColor: 'rgba(200,169,110,.28)', x: 4 }}
                    >
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.6 }}
                style={{ background: 'rgba(11,17,33,.88)', border: '.5px solid rgba(200,169,110,.13)', clipPath: CLIP.lg, overflow: 'hidden', backdropFilter: 'blur(8px)' }}
              >
                ...
                {reports.map((r, i) => (
                  <motion.div 
                    key={i} 
                    style={{ display: 'flex', alignItems: 'center', gap: '.75rem', padding: '.7rem 1rem', borderBottom: '.5px solid rgba(200,169,110,.05)', fontSize: '.75rem', cursor: 'pointer' }}
                    initial={{ opacity: 0, x: -10 }}
                    whileInView={{ opacity: 1, x: 0 }}
                    viewport={{ once: true }}
                    transition={{ delay: i * 0.05, duration: 0.3 }}
                    whileHover={{ backgroundColor: 'rgba(200,169,110,.04)' }}
                  >
                ...
                <div style={{ padding: '.75rem 1rem', borderTop: '.5px solid rgba(200,169,110,.06)', display: 'flex', justifyContent: 'flex-end' }}>
                  <motion.span 
                    style={{ fontSize: '.62rem', fontWeight: 700, letterSpacing: '.1em', color: '#C8A96E', textTransform: 'uppercase', cursor: 'pointer' }}
                    whileHover={{ color: '#EDD28A' }}
                    transition={{ duration: 0.2 }}
                  >View all reports →</motion.span>
                </div>
              </motion.div>
            </div>
          </div>
        ...
        <motion.section 
          ...
          viewport={{ once: true, amount: 0.2 }}
          variants={fadeInUp}
          style={{ position: 'relative', zIndex: 1, padding: '4rem 2.5rem 5rem' }}
        >
          <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
            ...
            {categories.map((c, i) => (
              <motion.div 
                ...
                style={{ 
                  ...
                  border: '.5px solid rgba(200,169,110,.13)',
                ...
                whileHover={{ 
                  y: -5, 
                  borderColor: 'rgba(200,169,110,.28)', 
              ...
              >
                ...
                <div className="fc" style={{ fontSize: '.82rem', fontWeight: 600, color: '#E5DCC8', marginBottom: '.35rem' }}>
                  {c.name}
                </div>
                <div className="fm" style={{ fontSize: '.62rem', color: c.cc, fontWeight: 700, letterSpacing: '.1em' }}>
                  {c.count}
                </div>
              </motion.div>
            ))}
        ...
        <motion.section 
          ...
          viewport={{ once: true, amount: 0.1 }}
          variants={fadeInUp}
          style={{ position: 'relative', zIndex: 1, padding: '0 0 5.5rem', overflow: 'hidden' }}
        >
          <div style={{ textAlign: 'center', marginBottom: '3.5rem', padding: '0 2.5rem' }}>
            <span style={{ display: 'block', fontSize: '.6rem', fontWeight: 700, letterSpacing: '.22em', textTransform: 'uppercase', color: '#C8A96E', marginBottom: '.75rem' }}>
              Community Voices
            </span>
            <h2 className="fc" style={{ fontSize: 'clamp(1.5rem,2.8vw,2.2rem)', fontWeight: 700, lineHeight: 1.2, color: '#E5DCC8' }}>
              Trusted Across the Galaxy
            </h2>
            <p style={{ maxWidth: 460, margin: '.5rem auto 0', fontSize: '.92rem', lineHeight: 1.7, color: '#8A8070', textAlign: 'center' }}>
              Relied upon by thousands of players every single day.
            </p>
          </div>
          ...
          <div style={{ overflow: 'hidden', marginBottom: '1rem' }}>
            <div className="marquee-left">
              {[...Array(2)].flatMap((_, ri) => 
                testimonialsRow1.map((p, i) => (
                  <motion.div 
                    key={`r1-${ri}-${i}`} 
                    style={{ clipPath: CLIP.proof, flexShrink: 0, width: 340, background: 'rgba(11,17,33,.88)', border: '.5px solid rgba(200,169,110,.13)', padding: '1.5rem', cursor: 'default', backdropFilter: 'blur(6px)' }}
                    whileHover={{ backgroundColor: '#0e1825', borderColor: 'rgba(200,169,110,.22)', y: -4 }}
                    transition={{ duration: 0.2 }}
                  >
        ...
        <motion.section 
          ...
          viewport={{ once: true, amount: 0.2 }}
          variants={fadeInUp}
          style={{ position: 'relative', zIndex: 1, padding: '0 2.5rem 6rem' }}
        >
          <motion.div 
            className="cta-borders" 
            style={{ clipPath: CLIP.xl, position: 'relative', maxWidth: 760, margin: '0 auto', background: 'rgba(11,17,33,.9)', border: '.5px solid rgba(200,169,110,.2)', padding: '4.5rem 4rem', textAlign: 'center', overflow: 'hidden', backdropFilter: 'blur(12px)' }}
            whileHover={{ borderColor: 'rgba(200,169,110,.35)' }}
          ...
          >
            ...
            <div style={{ display: 'flex', gap: '.85rem', justifyContent: 'center', flexWrap: 'wrap' }}>
              ...
              <motion.button 
                ...
                whileHover={{ scale: 1.05, backgroundColor: 'rgba(200,169,110,.08)', borderColor: 'rgba(200,169,110,.6)' }}
                whileTap={{ scale: 0.97 }}
              >
                Browse Reports
              </motion.button>
            ...
            <motion.div 
              style={{ display: 'flex', flexWrap: 'wrap', gap: '.5rem', justifyContent: 'center', marginTop: '1.75rem' }}
              initial={{ opacity: 0 }}
        ...
        <motion.footer 
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          style={{ position: 'relative', zIndex: 1, borderTop: '.5px solid rgba(200,169,110,.13)', padding: '2rem 2.5rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem', background: 'rgba(5,8,16,.92)', backdropFilter: 'blur(20px)' }}
        >
