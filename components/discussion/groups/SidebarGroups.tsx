...
import { clipHex, clipBadge } from '../clipStyles';
...
function NavItem({ href, icon, label, badge, isNew }: {
  href?: string;
      ...
      <div className="relative">
        ...
        <div className="absolute bottom-3 right-5 z-10">
          <div
            ...
            style={{ ...clipBadge, color: '#A855F7', borderColor: 'rgba(168,85,247,0.4)', background: 'rgba(168,85,247,0.08)' }}
          >
            ● GROUPS
          </div>
        </div>
